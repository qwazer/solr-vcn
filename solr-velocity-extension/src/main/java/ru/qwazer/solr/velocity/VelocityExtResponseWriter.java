package ru.qwazer.solr.velocity;
...
/**
 * @author ar
 * @since Date: 27.01.2014
 */
public class VelocityExtResponseWriter extends VelocityResponseWriter {
    ...
    public void write(Writer writer, SolrQueryRequest request, SolrQueryResponse response) throws IOException {
        ...
        context.put("digestUtils", DigestUtils.class);
